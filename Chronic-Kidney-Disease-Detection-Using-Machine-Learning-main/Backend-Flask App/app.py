...
#Loading the model
model = pickle.load(open('D:\mp\Chronic-Kidney-Disease-Detection-Using-Machine-Learning-main\Machine Learning model\CKD.pkl', 'rb'))
...
#     predictions = response_scoring.json()
    # predictions= lgr.predict([[90,157,1,0,0,1,1,1]])
